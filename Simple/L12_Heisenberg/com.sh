...
icc -g SSKomega.c  -DDSFMT_MEXP=19937 -DHAVE_SSE2 dSFMT.c -qopenmp -O3 -o SSKomega.out -L./lib -lkomega -I./include  -lmkl_intel_lp64 -lmkl_intel_thread -lmkl_core -lpthread 
